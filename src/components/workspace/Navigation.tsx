...
export function SideRail({
  ...
  return (
    <nav className="hidden w-[104px] shrink-0 border-r border-white/[0.06] bg-arkane-canvas/86 px-3 py-[calc(env(safe-area-inset-top)+18px)] shadow-[18px_0_50px_oklch(0%_0_0_/_0.18)] lg:block">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "bg-arkane-amber text-arkane-canvas shadow-amber"
...
export function BottomNav({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-white/[0.08] bg-arkane-canvas/95 px-2 pb-[calc(env(safe-area-inset-bottom)+8px)] pt-2 shadow-[0_-18px_38px_oklch(0%_0_0_/_0.32)] lg:hidden">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? "bg-arkane-amber text-arkane-canvas shadow-amber" : "text-arkane-muted [@media(hover:hover)]:hover:bg-white/[0.06]"
              )}
              aria-current={active ? "page" : undefined}
            >
              <Icon className="h-5 w-5" />
